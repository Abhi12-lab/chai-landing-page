...
1. **Via Netlify Drop:**
   ...
   - Your site will be live instantly with a netlify.app URL
...
2. **Via Git:**
   ...
   git remote add origin https://github.com/YOUR_USERNAME/royal-chai.git
...
2. **Via Git:**
   - Push to GitHub (see commands above)
...
2. **Enable GitHub Pages:**
   ...
   - Save
   - Your site will be live at: `https://YOUR_USERNAME.github.io/royal-chai/`
...
- ✅ Logo (custom SVG chai cup with animated steam)
- ✅ Tagline ("Brew the Royal Tradition")
- ✅ Brand description (premium chai premix from royal households)
- ✅ Email signup box (with validation and success message)
- ✅ "Launching Soon" element (animated banner with countdown)
- ✅ Social icons (Instagram, Facebook, Twitter, Pinterest)
- ✅ Mobile responsive (tested across all breakpoints)
- ✅ Clean, semantic HTML/CSS/JavaScript (separate files)
- ✅ Royal design theme (golds, browns, creams with elegant aesthetics)
